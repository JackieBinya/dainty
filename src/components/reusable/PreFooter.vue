<template>
  ...
  <section class="dty-pre--footer">
    <div class="dty--wrapper dty--wrapper--650px">
      <h4>Try dainty today 100% risk-free.</h4>
      <p>Unlimited graphics and web design request revisions for one monthly rate, no hourly biling or contract, cancel anytime. Start today with a free trial!</p>
      <span class="dty-btn--blue">Try us for free</span>
    </div>
  </section>
